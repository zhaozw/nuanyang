...
<center><table width=80% border="0">
  <tr>
    <td width="4"><td width="10"><center><td width="700"><div align="right"><img src="zhuce1.png" name="MyImage" width="600" height="420" align="middle" onLoad= "setTimeout('Begin( )',1000)">
      <script language="JavaScript">
var ImageArray=new Array( );
for (i=1;i<=3;i++)
{   ImageArray[i]=new Image( );
ImageArray[i].src="zhuce"+i+".png";
}
</script></td>
