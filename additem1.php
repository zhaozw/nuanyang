...
<!-- nav结束 -->
<h3> 　　　　</h3>
<center><h3><span class="STYLE1">发起项目</span></h3></center>
<p>&nbsp;</p>
<CENTER><form action="doAction.php?act=addItem" method="post" enctype="multipart/form-data">
<table width="1000px"  border="0" cellpadding="5" cellspacing="0" margin="0 auto">
	...
	<tr>
		...
		<td><input type="text" name="cName"  placeholder="请输入项目类别"/></td>
	</tr>
	<tr>
	...
	<center><tr>
		<td colspan="2">　　　　　
	      <input type="submit" value="发布项目"/></td>
	</tr></center>
</table>
</form></CENTER>
